        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 bg-gradient-to-br from-purple-600 to-purple-800 rounded-xl flex items-center justify-center purple-glow">
            ...
            <div className="flex items-center gap-3">
              <a href="#" className="p-2 bg-neutral-800 rounded-full hover:bg-purple-600 transition-colors">
