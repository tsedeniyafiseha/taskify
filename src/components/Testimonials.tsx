        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              whileHover={{ y: -8 }}
              className="group relative glass rounded-3xl p-8 hover:purple-glow transition-all duration-500 border border-neutral-800"
            >
              {/* Quote Icon */}
              ...
              {/* Testimonial Text */}
              <p className="text-neutral-300 mb-6 leading-relaxed relative z-10">
